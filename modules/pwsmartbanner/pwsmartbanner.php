...
*/
		...
		$fields_values['url2'] = $this->context->link->getModuleLink('pwsmartbanner', 'generate', array(), true);
		$fields_values['url3'] = $this->context->link->getModuleLink('pwsmartbanner', 'generate', array('cron'=>'1'), true);
