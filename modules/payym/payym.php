...
class payym extends PaymentModule
{	
	public function __construct()
	{
		...
		$this->displayName = $this->l('Оплата Яндекс. Деньги');
	...
	public function getContent()
	{
		...
		{
			Configuration::updateValue('PAYYM', Tools::getValue('PAYYM'));
		}
		...
		<form action="'.Tools::htmlentitiesUTF8($_SERVER['REQUEST_URI']).'" method="post">
			<fieldset><legend><img src="../modules/'.$this->name.'/logo.gif" /> '.$this->l('Настройки модуля оплаты').'</legend>
				...
				<div class="margin-form">
					<textarea name="PAYYM" cols="70" rows="10">'.Tools::getValue('PAYYM', Configuration::get('PAYYM')).'</textarea>
				</div>
				<div class="clear">&nbsp;</div>
	...
	public function hookPaymentReturn($params)
	{
		...
		$smarty->assign('paycontent', Configuration::get('PAYYM'));
