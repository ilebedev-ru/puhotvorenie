...
<div id="editorial_block_center" class="editorial_block">
    <div class="block_content box-line h3">
        <div>
            <ul id="productTabs-6" class="nav nav-tabs">
                <li class="active"><a>О магазине</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="about-store">
        ...
        {if $editorial->body_paragraph}{$editorial->body_paragraph|stripslashes}{/if}
    </div>
    {if $editorial->body_home_logo_link}
    <a href="{$editorial->body_home_logo_link|escape:'html':'UTF-8'}" title="{$editorial->body_title|escape:'html':'UTF-8'|stripslashes}">
        {/if}
