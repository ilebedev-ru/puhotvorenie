...
function initSliders() {
    $(sliderList).each(function (i, slider) {
        ...
        switch (slider['format']) {
            ...
            case 3:
            case 4:
                from = blocklayeredFormatCurrency($('#layered_' + slider['type'] + '_slider').slider('values', 0), slider['format'], '');
                to = blocklayeredFormatCurrency($('#layered_' + slider['type'] + '_slider').slider('values', 1), slider['format'], '');
                break;
            case 5:
        ...
        $('#layered_' + slider['type'] + '_range').find('#from').val(from);
        $('#layered_' + slider['type'] + '_range').find('#to').val(to);
    });
}
