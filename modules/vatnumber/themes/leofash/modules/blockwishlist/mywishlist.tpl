...
<div id="mywishlist">
	...
	<ul class="footer_links">
		<li>
			<a href="{$link->getPageLink('my-account', true)|escape:'html'}"><span class="fa fa-user"></span>{l s='Back to Your Account' mod='blockwishlist'}</a>
		</li>
		<li class="f_right">
			<span class="fa fa-home"></span>
			<a href="{$base_dir}">{l s='Home' mod='blockwishlist'}</a></li>
	</ul>
</div>
