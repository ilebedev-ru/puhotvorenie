    ...
    if (domAAroundImgThumb.attr('href'))
    {
        ...
        if ($('#bigpic').attr('src') != newSrc)
        {
			...
			if (typeof(jqZoomEnabled) != 'undefined' && jqZoomEnabled)
				$('#bigpic').attr('alt', domAAroundImgThumb.attr('href').replace('-thickbox',''));
			else
				$('#bigpic').attr('alt', domAAroundImgThumb.attr('title').replace('-thickbox',''));				
        }
        $('.thumbs a').removeClass('shown');
