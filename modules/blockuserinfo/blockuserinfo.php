...
class BlockUserInfo extends Module
{
    ...
    {
        return (parent::install() && $this->registerHook('displayTop') && $this->registerHook('displayNav') && $this->registerHook('displayHeader') && $this->registerHook('displayHeaderRight'));
    }
    ...
    public function hookdisplayHeaderRight($params)
    {
        ...
        return $this->display(__FILE__, 'blockuserinfo-right.tpl');
    }
}
