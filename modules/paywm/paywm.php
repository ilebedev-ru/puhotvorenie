...
class paywm extends PaymentModule
{	
	public function __construct()
	{
		...
		$this->displayName = $this->l('Оплата Webmoney');
	...
	public function getContent()
	{
		...
		{
			Configuration::updateValue('PAYWM', Tools::getValue('PAYWM'));
		}
		...
		<form action="'.Tools::htmlentitiesUTF8($_SERVER['REQUEST_URI']).'" method="post">
			<fieldset><legend><img src="../modules/'.$this->name.'/logo.gif" /> '.$this->l('Настройки модуля оплаты').'</legend>
				...
				<div class="margin-form">
					<textarea name="PAYWM" cols="70" rows="10">'.Tools::getValue('PAYWM', Configuration::get('PAYWM')).'</textarea>
				</div>
				<div class="clear">&nbsp;</div>
	...
	public function hookPaymentReturn($params)
	{
		...
		$smarty->assign('paycontent', Configuration::get('PAYWM'));
