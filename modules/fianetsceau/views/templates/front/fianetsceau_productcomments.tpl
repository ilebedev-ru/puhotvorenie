...
<div id="fianetsceau_general_content">
	...
	<div class="fianetsceau_center_content_global_note2"><span class="fianetsceau_global_note_text">{l s='Overall rating' mod='fianetsceau'}</span><div class="fianetsceau_space"></div>{$view_global_note|escape:'htmlall':'UTF-8'}<div class="fianetsceau_space"></div>{l s='on' mod='fianetsceau'} {$nb_comments|escape:'htmlall':'UTF-8'} {l s='customer reviews' mod='fianetsceau'}</div>
	...
	<div id="fianetsceau_comments">
		...
		<div class="fianetsceau_content">
			<div class="fianetsceau_left_content">
				{$comment.view_note|escape:'htmlall':'UTF-8'}<br/> {l s='by' mod='fianetsceau'} <span class="fianetsceau_capitalize">{$comment.firstname|escape:'htmlall':'UTF-8'}</span> <span class="fianetsceau_capitalize">{$comment.name|escape:'htmlall':'UTF-8'}</span><br/>{l s='at' mod='fianetsceau'} {$comment.date|escape:'htmlall':'UTF-8'}
			</div>
