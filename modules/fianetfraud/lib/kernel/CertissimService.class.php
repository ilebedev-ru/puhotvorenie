...
abstract class CertissimService extends CertissimMother
{
    ...
    'copilot' => array(
        'prod' => 'https://secure.fia-net.com/fscreener/engine/copilot.cgi',
        'test' => 'https://secure.fia-net.com/pprod/engine/copilot.cgi',
    )
    );
    
    //https://secure.fia-net.com/pprod/engine/copilot.cgi 
