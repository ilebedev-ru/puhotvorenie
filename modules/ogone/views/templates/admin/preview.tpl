...
<table class=ncoltable3 border="0" cellpadding="2" cellspacing="0" width="95%" id="ie_cc" style="behavior:url(#default#clientCaps)">
	...
	<td class="ncollogoc" valign="middle" align="center" width="33%"><a href="#"><img border="0" src="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/preview/PP_ogone2.gif" alt="Paiement trait&#233; parOgone" title="Paiement trait&#233; parOgone" vspace="2" id="NCOLPP"></a><br><small><small><a class="bottom" href="#" target="">A propos de Ogone</a> |<a class="bottom" href="#" target="_blank">Protection de la vie priv&#233;e<!--Privacy policy--></a> |<a class="bottom" href="#">S&#233;curit&#233;<!--Security--></a>| <a class="bottom" href="#" target="_blank">Informations l&#233;gales<!--Legal--></a></small></small></td><td class="ncollogoc" valign="middle" align="center" width="33%"><a href="#" target="VRSN_Splash"><IMG NAME="seal" BORDER="0" SRC="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/preview/vseal_Norton.gif" alt="Verisign" ></A></td></tr>
		<tr>
