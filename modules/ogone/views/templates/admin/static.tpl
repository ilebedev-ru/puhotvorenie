      ...
      <div class="ogone-config-block">
        ...
        <div class="row">
          <div class="quarter-block-3">
            <p class="ogone-subtitle">{l s='This page allows you to make yoyr customer\'s experience better by changing display of the payment page' mod='ogone'}</p>
            <section>
              <!-- OGONE_USE_TPL -->
        ...
        <div class="row">
          <div class="third-block">
            ...
            <div class="save_alert" id="st_save_alert">
              ...
              <input type="submit" name="submitOgoneStatic" value="{l s='Update settings' mod='ogone'}" class="button" style="float:right"/>
              <div class="clear"></div>
            </div>
