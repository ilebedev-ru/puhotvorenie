    ...
    <div class="full-block">
        ...
        <form action="{$form_action|escape:'htmlall':'UTF-8'}" method="post" enctype="multipart/form-data">
            <div class="ogone-config-block">
                <h2>{l s='Payment means' mod='ogone'}</h2>
                ...
                <div class="row">
                    <div class="quarter-block-3">
                        <section>
                            ...
                            <div class="form-group">
                                <label class="control-label">{l s='Default option name' mod='ogone'}</label>
                            ...
                            <!-- OGONE_USE_PM -->
                            <div class="form-group">
                                <label class="control-label">{l s='Use payement means' mod='ogone'}</label>
                                <div class="control-field">
                                    <input type="checkbox" id="OGONE_USE_PM" name="OGONE_USE_PM" {if $OGONE_USE_PM}checked="checked"{/if} />
                                    <div class="ogone-help">{l s='Allows you to propopose selected payment means directly' mod='ogone'}</div>
                                </div>
                            </div>
                        ...
                        <!-- OGONE_USE_KLARNA -->
                            <div class="form-group">
                                ...
                                <div class="control-field">
                                    ...
                                    <div class="ogone-help">{l s='Sets variables required by Klarna for every payment. Use if you are offering Klarna payment. If you add Klarna (named Installment or Open Invoice DE, NL, SE, FI, NO, DK) only as one of payment means, this option is not necessary. You need to have Klarna payment activated in Ingenico Backoffice.' mod='ogone'}</div>
                                </div>
                            </div>
                    ...
                    <div class="quarter-block block-info">
                        <div class="inner">
                            <h4>{l s='This options will display different payment means directly on payment choice page' mod='ogone'}</h4>
                            <ul>
                                <li>{l s='In order to propose different payment means, you need activate them.' mod='ogone'}</li>
                                <li>{l s='Click to activate payment mean, drag\'n\'drop to change order' mod='ogone'}</li>
                                <li>{l s='Please verify that payment means you are activating are disponible for your contract.' mod='ogone'}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="ogone-config-block">
                <h2>{l s='Choose payment means' mod='ogone'}</h2>
                <p class="ogone-subtitle">{l s='You can select which payment means will be proposed to customer on payment page.' mod='ogone'}</p>
                ...
                <section>
                    ...
                    <ul class="ogone_pm_list clear sortable">
                        {foreach $payment_means as $position=>$pm}
                            <li class="{if $pm->active}checked{/if}">
                                ...
                                <span class='ogone-pm-pm' title="{l s='PM and BRAND' mod='ogone'}">{$pm->pm|escape:'htmlall':'UTF-8'} : {$pm->brand|escape:'htmlall':'UTF-8'}</span>
        ...
        <form action="{$form_action|escape:'htmlall':'UTF-8'}" method="post" enctype="multipart/form-data">
            <div class="ogone-config-block">
                <h2>{l s='Add payment mean' mod='ogone'}</h2>

                <div class="row">
                    <div class="quarter-block-3">
                        <p class="ogone-subtitle">{l s='You can add simple payment mean.' mod='ogone'}
                        <strong>{l s='Please, make sure that payment mean you are adding is activated and configured in your Ingenico backoffice' mod='ogone'}</strong>
                         </p>
                        <section>
                            <div class="form-group">
                                <label class="control-label">{l s='PM' mod='ogone'}</label>
                                <div class="control-field">
                    ...
                    <div class="quarter-block block-info">
                        <div class="inner">
                            ...
                            <ul>
                                ...
                                <li>{l s='Please verify that payment means you are adding are disponible for your contract.' mod='ogone'}</li>
                                <li>{l s='Some payment means (like Klarna) needs additional configuration and shouldn\'t be added via this interface' mod='ogone'}</li>
            ...
            <div class="ogone-config-block">
                <section>
                    <div class="form-group ogone-submit">
                            <input type="submit" name="submitOgoneAddPM" value="{l s='Add new PM' mod='ogone'}" />
                    </div>
                </section>
            </div>
        </form>
