...
<div class="ogone-panel">
    <img src="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/logo.png" class="branded" alt="{l s='Logo branded' mod='ogone'}"/>

    <h2>{l s='One single platform to handle all your online transactions!' mod='ogone'}</h2>
    <img class="img-responsive" src="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/info_img1_{$lg_code|escape:'htmlall':'UTF-8'}.png" alt="{l s='Payment process' mod='ogone'}"/><br />

  <div class="half-block">

    <img class="img-responsive" src="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/info_img2_{$lg_code|escape:'htmlall':'UTF-8'}.png" alt="{l s='Payment process' mod='ogone'}"/>
