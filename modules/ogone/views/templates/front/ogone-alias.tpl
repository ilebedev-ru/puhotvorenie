...
<div class="row">
  <div class="col-xs-12">
    <p class="payment_module" onclick="document.forms['ogone_form_{$ogone_params.ALIAS|escape:'htmlall':'UTF-8'}'].submit(); return false;" >
      <a class="ogone alias"  href="#" title="{l s='Pay with Ingenico' mod='ogone'}">
  ...
  <form name="ogone_form_{$ogone_params.ALIAS|escape:'htmlall':'UTF-8'}" action="https://secure.ogone.com/ncol/{if $OGONE_MODE}prod{else}test{/if}/orderstandard_utf8.asp" method="post">
