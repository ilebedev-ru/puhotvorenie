...
<br>
        <div class="form">
		<form action="{$pwexpressorder_uri}" method="POST" class="std">
		  ...
		  {if !empty($conf.eo_phone_show)}
		   ...
		   {/if}
            <br>
		  <p class="text">
			<input type="submit" name="submitPwExpressOrder" class="button" value="{l s='Оформить заказ' mod='pwexpressorder'}">
		  </p>
		</form>
	  </div>
	</div>	
