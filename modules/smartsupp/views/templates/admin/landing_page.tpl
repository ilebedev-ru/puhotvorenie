	...
	<hr/>
        ...
        <div class="row text-center">
                <div class="row">
                        ...
                        <p>
                                <strong>{l s='See all features on' mod='smartsupp'} <a href="https://www.smartsupp.com" target="_blank">{l s='our website' mod='smartsupp'}</a>.</strong>
                        </p>
                </div>
        </div>
        ...
        <div class="row text-center">
                ...
                <div class="customers">
                        <a>
                                <img alt="ŠKODA AUTO a.s." src="{$module_dir|escape:'html':'UTF-8'}views/img/skoda.png">
                        </a>
                        <a>
                                <img alt="Microsoft Office" src="{$module_dir|escape:'html':'UTF-8'}views/img/microsoft.png">
                        </a>
                        <a>
                                <img title="SkyPicker" alt="SkyPicker" src="{$module_dir|escape:'html':'UTF-8'}views/img/skypicker.png">
                        </a>
                        <a>
                                <img title="Conrad" alt="Conrad" src="{$module_dir|escape:'html':'UTF-8'}views/img/conrad.png">
                        </a>
                </div>
        </div>                                        
</div>
