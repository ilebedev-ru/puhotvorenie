		...
		<div class="pos">{l s='UnHook Modules'  mod='leotempcp'} </div>
		 {foreach from=$modules item=module name=leotempcp}
			<div class="module-pos" id="module-{$module->id}">
				<a class="editmod" title="{l s='Configure' mod='leotempcp'}" href="{$moduleEditURL}&module_name={$module->name}&configure={$module->name}" data-mod="{$module->name}"></a>
		...
		<div id="leo-header" >
			<div class="topbar leo-container" data-position="displayTop">
				...
				<div class="module-pos" id="module-{$module['instance']->id}" data-position="{$module['id_hook']}">
					<a class="editmod" title="{l s='Configure' mod='leotempcp'}" href="{$moduleEditURL}&module_name={$module['name']}&configure={$module['name']}" data-mod="{$module['name']}"></a><div class="edithook"></div>
