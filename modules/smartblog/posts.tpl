...
<div id="content" class="block">
    <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
        ...
        {if !$id_category>1 && !$countcomment}
            <div class="post-info">
			   ...
			   <span itemprop="author">{if $smartshowauthorstyle != 0}{$firstname} {$lastname}{else}{$lastname} {$firstname}{/if}</span>&nbsp;<i
                        class="icon icon-calendar"></i>&nbsp;
			   <span itemprop="dateCreated">{$created|date_format}</span>{/if}&nbsp;&nbsp;<i class="icon icon-tags"></i>&nbsp;<span
                            itemprop="articleSection">
                               {if $id_category>1}
                        <a href="{smartblog::GetSmartBlogLink('smartblog_category',$catOptions)}">{$title_category}</a></span> &nbsp;<i
                        class="icon icon-comments"></i>
                    {/if}
                    &nbsp; {if $countcomment != ''}{$countcomment} {l s=' Comments' mod='smartblog'}{else}{/if}</span>
        ...
        <div itemprop="articleBody">
            <div id="lipsum" class="articleContent">
                ...
                {if ($post_img != "no" && $activeimgincat == 0) || $activeimgincat == 1}
                    <a id="post_images" href="{$modules_dir}/smartblog/images/{$post_img}-single-default.jpg"><img
                                src="{$modules_dir}/smartblog/images/{$post_img}-single-default.jpg" alt="{$title}"></a>
                {/if}
            </div>
            <div class="sdsarticle-des">
                {$content}
            </div>
            {if isset($products) && $products}{include file="$tpl_dir./product-list-new.tpl" products=$products}{/if}
            {if $tags != ''}
                <div class="sdstags-update">
                    <span class="tags"><b>{l s='Tags:' mod='smartblog'} </b>
                        {foreach from=$tags item=tag}
                            ...
                            <a title="tag"
                               href="{smartblog::GetSmartBlogLink('smartblog_tag',$options)}">{$tag.name}</a>
                        {/foreach}
                    </span>
                </div>
            {/if}
    ...
    {if $countcomment != ''}
        <div id="articleComments">
            <h3>{if $countcomment != ''}{$countcomment}{l s=' Comments' mod='smartblog'}
                    <span></span>
                {else}{l s='0' mod='smartblog'}{/if} </h3>
                ...
                <table>
                    <form action="" method="post" id="commentform">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" tabindex="1" class="inputName form-control grey" value=""
                                       name="name">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="required">*</span> <b>{l s='E-mail:'  mod='smartblog'} </b><span
                                        class="note">{l s='(Not Published)'  mod='smartblog'}</span></td>
                            <td>
                                <input type="text" tabindex="2" class="inputMail form-control grey" value=""
                                       name="mail">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea tabindex="4" class="inputContent form-control grey" rows='8" cols=' 50"
                        ...
                        {if Configuration::get('smartcaptchaoption') == '1'}
                            ...
                            <tr>
                                ...
                                <td><input type="text" tabindex="" value="" name="smartblogcaptcha"
                                           class="smartblogcaptcha form-control grey"></td>
                            </tr>
                        {/if}
                        </tbody>
                </table>
                ...
                <div class="right">
                    ...
                    <div class="submit">
                        <input type="submit" name="addComment" id="submitComment"
                               class="button btn btn-default button-medium" value="Отправить">
                    </div>
