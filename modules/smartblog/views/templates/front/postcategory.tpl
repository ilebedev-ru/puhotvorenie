...
{else}
    {if $smartdisablecatimg == '1'}
        ...
        {if $title_category != ''}
            ...
            <div id="smartblogCategory" class="rte">
                {if ($cat_image != "no" && $activeimgincat == 0) || $activeimgincat == 1}
                    <img alt="{$categoryinfo.meta_title}" src="{$modules_dir}/smartblog/images/category/{$cat_image}-home-default.jpg" class="imageFeatured">
                {/if}
