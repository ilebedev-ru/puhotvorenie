<div class="col-1">
	...
	{if isset($images) && count($images) > 0}
		...
		{if isset($images) && count($images) > 4}<span class="view_scroll_spacer"><a class="view_scroll_left view_scroll_left_{$product.id_product}" rel="{$product.id_product}" class="hidden" title="{l s='Other views' mod='leocustomajax'}" href="javascript:{ldelim}{rdelim}">{l s='Previous' mod='leocustomajax'}</a></span>{/if}
	...
	{if isset($images) && count($images) > 4}<a class="view_scroll_right view_scroll_right_{$product.id_product}" rel="{$product.id_product}" title="{l s='Other views' mod='leocustomajax'}" href="javascript:{ldelim}{rdelim}">{l s='Next' mod='leocustomajax'}</a>{/if}
	</div>
	{/if}
</div>