...
{if isset($products)}
	...
	{foreach from=$products item=product name=products}
        {if $page_name == 'product' AND $product.id_product == $viewingProduct}
            {continue}
        {/if}
		<div class="product_block {if $page_name == "index" OR $isFour}col-md-3{elseif $page_name != "index"}col-md-4{/if} col-sm-6 col-xs-12" {if $page_name == "cms"}style="width: 24%" {/if}{if isset($widthProductBlock)} style="width: {$widthProductBlock}%"{/if}>
