...
<div id="content" class="block">
    <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
        ...
        <div itemprop="articleBody">
            ...
            <div id="article-content">
                    <a id="article-images" href="{$modules_dir}/smartblog/images/{$post_img}-single-default.jpg"><img src="{$modules_dir}/smartblog/images/{$post_img}-single-default.jpg" alt="{$title}"></a>
            </div>
            {/if}
            <div id="article" class="sdsarticle-des">
                {$content}
            </div>
    ...
    {if $countcomment != ''}
        <div id="article-comments">
            <h3>{if $countcomment != ''}{l s=' Comments' mod='smartblog'} ({$countcomment})
