...
{assign var="viewingProduct" value=$product->id}
    ...
    {*{fd($product)}*}
        ...
        <div id="pb-right-column" class="col-md-4 col-sm-6">
            ...
            <div id="image-block">
				...
				<img src="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'large_default')|escape:'html'}"

                     class="{if $jqZoomEnabled && $have_image}jqzoom{/if} img-responsive"

                     title="{if !empty($cover.legend)}{$cover.legend|escape:'htmlall':'UTF-8'}{else}{$product->name|escape:'htmlall':'UTF-8'}{/if}"

                     alt="{if !empty($cover.legend)}{$cover.legend|escape:'htmlall':'UTF-8'}{else}{$product->name|escape:'htmlall':'UTF-8'}{/if}"

                     id="bigpic" width="{$largeSize.width}" height="{$largeSize.height}"/>
            ...
            {if isset($images) && count($images) > 0}
                ...
                <div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if}">
                    ...
                    {if isset($images) && count($images) > 3}<span class="view_scroll_spacer"><a id="view_scroll_left"

                                                                                                 class="hidden"

                                                                                                 title="{l s='Other views'}"

                                                                                                 href="javascript:{ldelim}{rdelim}"><i

                                    class="fa fa-angle-left"></i></a></span>{/if}
                            ...
                            {if isset($images)}
                                ...
                                {foreach from=$images item=image name=thumbnails}
                                    ...
                                    <li id="thumbnail_{$image.id_image}">
                                        ...
                                        <a href="{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html'}"
                                           ...
                                           title="{$imageTitlte}">
                                            ...
                                            <img id="thumb_{$image.id_image}"
                                                 ...
                                                 alt="{$imageTitlte}" title="{$imageTitlte}"
                    ...
                    {if isset($images) && count($images) > 3}<a id="view_scroll_right" title="{l s='Other views'}"
        ...
        <div id="pb-left-column" class="col-md-8 col-sm-6">
           ...
           {* {else} *}
            ...
            <div class="content_prices clearfix">
                ...
                {if $product->show_price AND !isset($restricted_country_mode) AND !$PS_CATALOG_MODE}
					...
					{/if}-->
                            ...
                            <sup id="old_price"{if !$product->specificPrice || !$product->specificPrice.reduction} class="hidden"{/if}>
                        ...
                        {elseif $product->specificPrice AND $product->specificPrice.reduction AND $productPriceWithoutReduction > $productPrice}
                            ...
                            <span class="discount">-{$product->specificPrice.reduction * 100}%</span>
            ...
            <div class="btn-block">
                ...
                *}
                ...
                {*</p>*} <label id="add_to_cart" for="add_cart"
                            ...
                            {if (!$allow_oosp && $product->quantity <= 0) OR !$product->available_for_order OR (isset($restricted_country_mode) AND $restricted_country_mode) OR $PS_CATALOG_MODE}style="display:none"{/if}
            ...
            {*{if isset($product) && $product->description}*}
                        ...
                        <p style="font-size: 28px" class="{*short_description-delivery_info*}">Способы доставки</p> {*<i class="fa fa-angle-down short_description-delivery_info-down" aria-hidden="true"></i>*}

                        <div class="short_description-delivery_info-show">

                            {hook h="displayDeliveryMethods"}
            ...
            {if ($product->show_price AND !isset($restricted_country_mode)) OR isset($groups) OR $product->reference OR (isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS)}
                ...
                <form id="buy_block"
                      ...
                      {if $PS_CATALOG_MODE AND !isset($groups) AND $product->quantity > 0}class="hidden"{/if}

                      action="{$link->getPageLink('cart', true)|escape:'html'}" method="post">
                                            ...
                                            <div class="attribute_list">
                                                ...
                                                {if ($group.group_type == 'select')}
                                                    ...
                                                    <select name="{$groupName}" id="group_{$id_attribute_group|intval}"
                                                            ...
                                                            class="attribute_select form-control"
            ...
            <div id="more_info_block" class="block clear">
                ...
                <ul id="more_info_tabs" class="idTabs idTabsShort clearfix">
                    ...
                    {if isset($accessories) AND $accessories}
                        ...
                        <li><a href="#idTab4">{l s='Accessories'}</a></li>{/if}
                        ...
                        <ul id="idTab9" class="bullet">
                            ...
                            {foreach from=$attachments item=attachment}
                                ...
                                <li>
                                    ...
                                    <a href="{$link->getPageLink('attachment', true, NULL, "id_attachment={$attachment.id_attachment}")|escape:'html'}">{$attachment.name|escape:'htmlall':'UTF-8'}</a><br/>{$attachment.description|escape:'htmlall':'UTF-8'}
